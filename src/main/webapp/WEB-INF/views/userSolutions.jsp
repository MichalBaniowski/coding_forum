                ...
                <div class="col col-md-11 col-sm-10">
                    ...
                    <p>
                        <button class="btn btn-light" type="button" data-toggle="collapse"
                                data-target="#collapseCommentForm${solution.id}" aria-expanded="false"
                        ...
                        <button class="btn btn-light" type="button" data-toggle="collapse"
                                data-target="#collapseComments${solution.id}" aria-expanded="false"
                                aria-controls="collapseExample">
                            komentarze(${solution.comments.size()})
                        </button>
                        <a href="/exercise?id=${solution.exercise.id}" class="btn btn-light">
                            idź do zadania
                        </a>
                    </p>
                            ...
                            <div class="col-sm-12 col-md-10 centered">
                                <form method="post" action="/user/add-comment">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="descriptionContent"
                                                  placeholder="treść" rows="6"></textarea>
                                    </div>
